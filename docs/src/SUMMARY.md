...
- [CLI Basics](./tutorials/cli-basics.md)
- [opq + Claude Code (MCP)](./tutorials/mcp-claude-code.md)
- [TTL & Revocation](./tutorials/ttl-and-revocation.md)
- [Sandbox & Hardening](./tutorials/sandbox-and-hardening.md)
...
- [Paths & Configuration](./reference/paths-and-config.md)

# Security Model

- [Threat Model](./security/threat-model.md)
- [The Redactor](./security/redactor.md)
- [The Sandbox](./security/sandbox.md)
- [TTL & Revocation Internals](./security/ttl-revocation.md)
